...
class TestLoadConfig:
    """load_config reads ~/.meadow_bridge/config.json."""
    ...
    def test_creates_default_when_no_file(self, tmp_path: Path) -> None:
        ...
        cfg_file = tmp_path / ".meadow_bridge" / "config.json"
        with (
            patch("meadow_bridge.config.config_path", return_value=str(cfg_file)),
            patch("meadow_bridge.config.config_dir", return_value=str(cfg_file.parent)),
        ):
            cfg = load_config()
    ...
    def test_loads_valid_json(self, tmp_path: Path) -> None:
        ...
        with patch("meadow_bridge.config.config_path", return_value=str(cfg_file)):
            cfg = load_config()
